...
namespace AetherSenseRedux
{
    ...
    {
        public static string Name => "AetherSense Redux";
        ...
        public bool Scanning
        {
            get
            {
                ...
                return true; // Buttplug.IsScanning;
            }
        }
        ...
        private async Task InitButtplug()
        {
            ...
            if (!Connected)
            {
                try
                {
                    ButtplugWebsocketConnector wsOptions = new ButtplugWebsocketConnector(new Uri(Configuration.Address));
